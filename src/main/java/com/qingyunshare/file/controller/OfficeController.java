...
import com.qingyunshare.file.api.IUserService;
import com.qingyunshare.file.domain.FileBean;
import com.qingyunshare.file.domain.FileModel;
import com.qingyunshare.file.domain.UserBean;
import com.qingyunshare.file.domain.UserFile;
import com.qingyunshare.file.dto.file.CreateOfficeFileDTO;
import com.qingyunshare.file.dto.file.EditOfficeFileDTO;
import com.qingyunshare.file.dto.file.PreviewOfficeFileDTO;
import com.qingyunshare.file.helper.ConfigManager;
...
//            fileBean.setPointCount(1);
    ...
    public RestResult<Object> editOfficeFile(HttpServletRequest request, @RequestBody EditOfficeFileDTO editOfficeFileDTO, @RequestHeader("token") String token) {
        ...
        try {
            ...
            file.editorConfig.callbackUrl= baseUrl + "/office/IndexServlet" + query;
            System.out.println("file.editorConfig.callbackUrl = " + file.editorConfig.callbackUrl);
