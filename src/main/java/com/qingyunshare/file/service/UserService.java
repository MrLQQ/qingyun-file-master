...
import com.qingyunshare.file.component.UserDealComp;
import com.qingyunshare.file.api.IUserService;
import com.qingyunshare.file.controller.UserController;
import com.qingyunshare.file.domain.UserBean;
import com.qingyunshare.file.mapper.UserMapper;
...
//        UserController.verificationCodeMap.remove(telephone);
        ...
        // 使用MD5配合盐值以及1024迭代返回经过hash加密后的password
